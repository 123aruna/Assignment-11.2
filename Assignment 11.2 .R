...
bankaddfull1<-read_delim("C:/Users/aruna/Desktop/Assignments/home work acadgild/bank-additional/bank-additional-full.csv",";", escape_double = FALSE, trim_ws = TRUE)
str(bankaddfull1)
